    ...
    return {
        ...
        async execute(_toolCallId, params, signal, onUpdate, _ctx) {
            return withToolError("steel_scrape", async () => {
                ...
                const pathSuffix = limitedResult.truncated
                    ? `\n\n[Output truncated. Read the full content with the Read tool: ${displayPath}]`
                    : `\n\nContent saved to: ${displayPath}`;
                return {
                    content: [{ type: "text", text: limitedResult.text + pathSuffix }],
                    details: {
