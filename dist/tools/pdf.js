...
async function writeBinaryArtifact(filePath, payload) {
...
async function generatePdf(session, filePath) {
...
export function pdfTool(client) {
    return {
        name: "steel_pdf",
        label: "PDF",
        ...
        async execute(_toolCallId, params, signal, onUpdate, _ctx) {
            return withToolError("steel_pdf", async () => {
                ...
                const options = {
                    printBackground: params.printBackground !== undefined
                        ? params.printBackground
                        : DEFAULT_PDF_OPTIONS.printBackground,
                    preferCSSPageSize: params.preferCSSPageSize !== undefined
