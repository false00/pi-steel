...
let cachedDefaultToolTimeoutMs = null;
...
export function getDefaultToolTimeoutMs() {
    ...
    cachedDefaultToolTimeoutMs = Math.max(MIN_TOOL_TIMEOUT_MS, Math.min(parsed, MAX_TOOL_TIMEOUT_MS));
    return cachedDefaultToolTimeoutMs;
}
export function resolveToolTimeoutMs(rawTimeout) {
